    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin trananh.vn</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> Hồ sơ cá nhân</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="danhmuc_hanghoa.html">Danh mục hàng hóa</a>
                                </li>
                                <li>
                                    <a href="danhmuc_ncc.html">Danh mục nhà cung cấp</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Danh mục thương hiệu</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Danh mục chi nhánh</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Danh mục tỉnh thành</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Chuyên mục bài viết</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="danhmuc_ncc.html">Nhập kho</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Xuất kho</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">QL tồn kho</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Khuyến mại - giảm giá</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> QL cấu hình website<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="danhmuc_hanghoa.html">Cấu hình menu</a>
                                </li>
                                <li>
                                    <a href="danhmuc_ncc.html">Cấu hình quảng cáo</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Cấu hình slide</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">Cấu hình chung</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="danhmuc_ncc.html">QL góp ý - liên hệ</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">QL bản đồ chi nhánh</a>
                                </li>
								<li>
                                    <a href="danhmuc_ncc.html">QL lịch sử hoạt đông HT</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
											<div class="btn-group dropup">	
												<button aria-expanded="false" data-toggle="dropdown" class="btn btn-sm btn-warning dropdown-toggle waves-effect waves-light" type="button"><i class="fa fa-bars m-r-5"></i><span class="caret"></span></button>	<ul role="menu" class="dropdown-menu">		<li><a href="#"><i class="fa fa-trash"></i> Xóa </a></li>		<li><a href="#"><i class="fa fa-lock"></i> Khóa</a></li>		<li><a href="#" data-id="20171219000037" class="btnSua"  data-toggle="modal" data-target="#myModal"><i class="fa fa-edit"></i> Sửa</a></li>		<li><a <a href="#"><i class="fa fa-street-view"></i> Xem trước</a></li>	</ul></div>
